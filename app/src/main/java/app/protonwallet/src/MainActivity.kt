...
import app.protonwallet.src.activity.*
import app.protonwallet.src.manager.NetManager
import app.protonwallet.src.manager.UIManager
import app.protonwallet.src.manager.WalletManager
import app.protonwallet.src.utils.Constants
import app.protonwallet.src.utils.PermissionHelper
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var backup: FrameLayout
    lateinit var okbtn: Button
    lateinit var tfacopy: ImageButton
    lateinit var ultimatepasswordcopy: ImageButton
    lateinit var tfa: TextView
    lateinit var ultimatepassword: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        PrefsUtil.prefs = getSharedPreferences("app.protonwallet.src", Context.MODE_PRIVATE)
        PrefsUtil.loadPrefs()
    ...
    private fun findViews() {
        ...
        this.backup = this.findViewById(R.id.backup)
        this.okbtn = this.findViewById(R.id.btnsaveok)
        this.tfa = this.findViewById(R.id.tfa_password)
        this.ultimatepassword = this.findViewById(R.id.ultimate_password)
        this.tfacopy = this.findViewById(R.id.copytfa)
        this.ultimatepasswordcopy = this.findViewById(R.id.copyultimatedpass)
